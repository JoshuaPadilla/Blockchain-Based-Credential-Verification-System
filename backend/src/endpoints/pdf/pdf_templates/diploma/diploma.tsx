  ...
  return (
    <Document>
      <Page size="A4" orientation="landscape" style={styles.page}>
        ...
        {/* LAYER 2: Border */}
        <Image src={borderPath} style={styles.border} fixed />
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.bodyText}>
            Be it known that the Board of Regents by authority of the Republic
            of the Philippines upon recommendation of the University Council has
            awarded to
          </Text>
          ...
          {/* DISTINCTION */}
          {distinction && <Text style={styles.distinction}>{distinction}</Text>}

          {/* Testimony */}
          <Text style={styles.testimony}>
            IN TESTIMONY WHEREOF, the seal of the University and the signatures
            of the University President and the Registrar are hereunto affixed.
          </Text>
          ...
          <View style={styles.signatureRow}>
            <View style={styles.signatureBlock}>
              <Text style={styles.signatoryName}>RYAN EMIL T. ZOSA, IV</Text>
              <Text style={styles.signatoryTitle}>University Registrar</Text>
            </View>
            ...
            <View style={styles.signatureBlock}>
              ...
              <Text style={styles.signatoryTitle}>University President</Text>
            </View>
          </View>
